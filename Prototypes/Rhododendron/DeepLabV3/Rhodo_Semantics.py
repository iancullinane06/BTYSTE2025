...
def create_deeplabv3_model(input_shape, num_classes=1):
    ...
    # ASPP branch 1
    b1 = DepthwiseConv2D((3, 3), dilation_rate=1, padding="same", use_bias=False)(x)
    ...
    # ASPP branch 2
    b2 = DepthwiseConv2D((3, 3), dilation_rate=2, padding="same", use_bias=False)(x)
    ...
    # ASPP branch 3
    b3 = DepthwiseConv2D((3, 3), dilation_rate=3, padding="same", use_bias=False)(x)
